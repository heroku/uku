...
const config = {
  ...
  'server': {
    ...
    'plugins': {
      ...
      '$filter': 'env',
      'production': require('hoek').applyToDefaults(plugins.always, plugins.production),
  ...
  'redis': {
    '$meta': 'Please see: https://github.com/ddollar/redis-url',
    '$meta': 'Example: redis://[:password@]host:port[/db-number][?option=value]',
    '$filter': 'env',
    'production': {
